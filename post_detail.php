                ...
                <form action="func/rating.php" method="post" id="rating_form">
                    <div class='row'>
                        ...
                        <div class='col-3 mt-2'>
                            <button type="submit" class='btn btn-success col-8'>Rating</button>
                        </div>
                        <div class='col-3 mt-2'>
                            <button type="reset" class="btn btn-warning col-8">Reset</button>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="card bg-light">
                    <div class="card-body">
                        ...
                        <form class="mb-4" action="func/comment.php" method="post">
                            ...
                            <button class='btn btn-success col-4' id="comment_submit" type="submit" name="comment">Comment</button>
                        </form>
                        ...
                        <div class="input-group">
                            <form action="post_detail.php" method="post" class='form-inline' style="width: 100%;">
                                ...
                                <div class='col-6' style="padding:2px">
                                    <a class="btn btn-primary" href="#" role="button">Update Post</a>
                                </div>

                                <div class='col-6' style="padding:2px">
                                    <button type="submit" name="delete" class="btn btn-danger" id="button-search" type="button">Delete Post</button>
                                </div>
